...
func (m *MockHTTP) Read(w http.ResponseWriter, r *http.Request) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "Read", w, r)
}

// Read indicates an expected call of Read.
func (mr *MockHTTPMockRecorder) Read(w, r interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Read", reflect.TypeOf((*MockHTTP)(nil).Read), w, r)
}
