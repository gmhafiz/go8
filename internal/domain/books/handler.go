...
// @Router /books [get]
func (h *BookHandler) All() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		resp, err := h.BookUseCase.All(r.Context())
		if err != nil {
...
func (h *BookHandler) Create() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		err = h.Validator.Struct(bookRequest)
		if err != nil {
			var errs []string
		...
		book, err := h.BookUseCase.Create(r.Context(), &model.Book{
...
func (h *BookHandler) Get() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		id := r.Context().Value("id").(int64)

		book, err := h.BookUseCase.Get(r.Context(), id)
		if err != nil {
			render.Status(r, errors_handling.GetStatusCode(err))
			render.JSON(w, r, errors_handling.ResponseError{Error: err.Error()})
			return
...
func (h *BookHandler) Update() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		book, err := h.BookUseCase.Update(r.Context(), bookRequest)
		if err != nil {
			render.Status(r, errors_handling.GetStatusCode(err))
			render.JSON(w, r, errors_handling.ResponseError{Error: err.Error()})
			return
...
func (h *BookHandler) Delete() http.HandlerFunc {
	...
	return func(w http.ResponseWriter, r *http.Request) {
		...
		err = h.BookUseCase.Delete(r.Context(), id, deleteType.HardDelete)
		if err != nil {
			render.Status(r, errors_handling.GetStatusCode(err))
			render.JSON(w, r, errors_handling.ResponseError{Error: err.Error()})
			return
...
func (h *BookHandler) Search() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		res, err := h.BookUseCase.Search(r.Context(), searchQuery[0])
		if err != nil {
			render.Status(r, errors_handling.GetStatusCode(err))
			render.JSON(w, r, errors_handling.ResponseError{Error: err.Error()})
			return
